...
I escalated. The batch was held and never reached the modelling team. My manager corrected the data.
...
That's the actual finding. A pipeline moving hundreds of thousands of records had no standing reconciliation against source, and the gap stayed invisible until somebody happened to ask.
...
I finished an MSc in Artificial Intelligence at National College of Ireland in 2026. So I know what a model does with quietly wrong inputs: it produces a confident answer and gives you no reason to doubt it.
...
Useful things to know before we talk: I'm based in Ireland and available from September 2026. I'm looking for data governance and data quality work, ideally in pharma. Happy to work inside your environment and under your access rules, and I'd rather ask about those on the call than assume.
